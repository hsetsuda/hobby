...
int main(int argc, char *argv[]){
  ...
  if(argc!=6){
    cerr << "Usage : gaus_random_number <RepeatNum> <theta[deg]> <vd[mm/ns]> <y(z=0)[mm]> <savename>" <<endl;
    exit(1);
  }
  ...
  double a = 1.0;  //  electron cluster number [/mm]
  double Mean_n = a*L;
  ...
  double b = -1*atof(argv[4])/tan(theta); // segment of truth track function z=ay+b [mm]
