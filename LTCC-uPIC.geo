...
Point( 19) = { 0, -r7, -tc, lc}; 
Point( 20) = { 0,   0, -tc*2}; 
Point( 21) = { 0,  r7, -tc*2, lc}; 
Point( 22) = { 0, -r7, -tc*2, lc}; 
...
Point( 29) = { 0,   0, -tc*3}; 
Point( 30) = { 0,  r10, -tc*3, lc}; 
Point( 31) = { 0, -r10, -tc*3, lc}; 
...
Point( 36) = { 0,   0, -tc*4}; 
Point( 37) = { 0,  r10, -tc*4, lc}; 
Point( 38) = { 0, -r10, -tc*4, lc}; 
...
Line loop( 16) = { 27, 28};
Line loop( 17) = { 29, 30};
Line loop( 18) = { 27, 32, -29, -31};
Line loop( 19) = { 28, 31, -30, -32};
// 3rd
...
Line loop( 25) = { 41, 42};
Line loop( 26) = { 43, 44};
Line loop( 27) = { 41, 46, -43, -45};
Line loop( 28) = { 42, 45, -44, -46};
// 4th
...
// anode
Surface loop(  2) = {  7,  8,  9, 15, 16, 17, 23, 24, 31, 32, 33, 34, 35, 36, 37, 38,106,111,112};
// cathode
Surface loop(  3) = {103,105,107,108,109,110,113,114};
// bottom
Surface loop(  4) = { 39, 40, 41, 42, 43, 44, 45, 34};
// LTCC1
Surface loop(  5) = {  2,  3,  4,  5,  6,  7,  8,  9,101,102,103,104};
// LTCC2
Surface loop(  6) = {  2, 10, 11, 12, 13, 14, 15, 16, 17};
// LTCC3
...
// Physical Surface
// Anode
Physical Surface( 1)  = {  7,  8,  9, 15, 16, 17, 23, 24, 31, 32, 33, 34, 35, 36, 37, 38,106,111,112};
// Cathode
